...
import { KeywordConfig, Category } from '../types';
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      <div className="p-6 border-b border-slate-200 bg-slate-50">
        <h2 className="text-lg font-bold text-slate-800">情報來源設定</h2>
        <p className="text-sm text-slate-500 mt-1">管理 Google Alerts RSS 的監測關鍵字與分類。</p>
      </div>
